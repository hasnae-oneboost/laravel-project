...
class CreateSocietesAssurancesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('societes_assurances', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('societes_assurances');
    }
}
