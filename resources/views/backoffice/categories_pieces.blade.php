        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body no-padding">
                    <form id="login-form" class="smart-form" action="{{route('backoffice_categories_pieces_ajouter')}}" method="POST">
                        {{csrf_field()}}
                                <fieldset>                                    
                                    <section>
                                            <div class="row">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body no-padding">
                ...
                <form id="login-form" class="smart-form" action="{{route('backoffice_categories_pieces_modifier')}}" method="POST">
                    {{csrf_field()}}
                    {{method_field('PATCH')}}                            
                        <fieldset>
                            <section>
                            ...
                            <section>
                                    <div class="row">
                                        ...
                                        <div class="col col-10">
                                            <label class="input">
                                                <select name="famille" id="" required>
                                                    <option value="{{$ca->famille_id}}">{{$ca->famille->libelle}}</option>
                                                    @foreach($familles as $f)
                                                    <option value="{{$f->id}}">{{$f->libelle}}</option>
                                                    @endforeach
                                                </select>
                            ...
                            <section>
                                    <div class="row">
                                        ...
                                        <div class="col col-10">
                                            <label class="input">
                                                <select name="famille" id="" required>
                                                    <option value="{{$cat->famille_id}}">{{$cat->famille->libelle}}</option>
                                                    @foreach($familles as $f)
                                                    <option value="{{$f->id}}">{{$f->libelle}}</option>
                                                    @endforeach
                                                </select>
...
<div class="modal fade" id="Supprimer-{{$categori->id}}"  tabindex="-1" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
            ...
            <form id="login-form" class="smart-form" action="{{route('backoffice_categories_pieces_supprimer')}}" method="POST">
                    {{csrf_field()}}
                    {{method_field('delete')}}
                            <fieldset>                                            
