                                    ...
                                    <article class="col-sm-12 col-md-12 col-lg-12">
                                        ...
                                        <div class="jarviswidget" id="wid-id-0" data-widget-colorbutton="false" data-widget-deletebutton="false" data-widget-togglebutton="false" data-widget-editbutton="false" data-widget-custombutton="false">
                                            ...
                                            <header>
                                                    ...
                                                    <h2>Modifier le Contrat d'achat </h2>
                                            ...
                                            <div class="widget-body">
                                              ...
                                              <form class="smart-form" files="true" action="{{route('backoffice_contrat_achat_modifier')}}" method="POST" enctype="multipart/form-data">
                                            {{csrf_field()}}
                                            {{method_field('PATCH')}}
                                                <header></header>
                                    ...
                                    <fieldset>
                                        <div class="row">
                                            ...
                                            <section class="col col-6">
                                                ...
                                                <label class="input">
                                                 ...
                                                 <input type="text" class="form-control" name="code" value="{{$contrats->code}}" required>
                                                </label>
                                        ...
                                        <div class="row">
                                            ...
                                            <section class="col col-6">
                                                                ...
                                                                <label class="input">                                                                    
                                                         <input type="text" class="form-control" name="date_achat" id="date" value="{{$contrats->date_achat}}" required>
                                        ...
                                        <div class="row">
                                                <section class="col col-6">
                                                        ...
                                                        <label class="input">                                                                    
                                                            <input type="text" class="form-control" name="garantie" value="{{$contrats->garantie}}" required>
                                                        </label>
                                                </section>
                                                <section class="col col-6">
                                                        <label class="label">
                                                        ...
                                                        <label class="input">                               
                                                            <input type="number" name="montant_ht"  min="0" step="0.01" value="{{$contrats->montant_ht}}" required>
                                        ...
                                        <div class="row">                                  
                                            ...
                                            <section class="col col-6">
                                                        ...
                                                        <label class="input">                                                                  
                                                            <input type="number" min="0" step="0.01" id="ttc" name="montant_ttc" value="{{$contrats->montant_ttc}}" required>
