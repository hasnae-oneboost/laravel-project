...
@section('content')
        ...
        <div class="pull-right">
                                <div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
                                    <h1 class="page-title txt-color-blueDark">
                                        @permission('Créer') 
                                        <div class="">
                                            <a href="{{route('backoffice_contrat_location_ajout')}}" class="btn btn-red btn-lg">Ajouter</a>    
                                        </div>
                                        @endpermission
                                    </h1>
                                </div>
                                ...
                                <div class="panel panel-default">
                                  ...
                                  <div id="collapseOne" class="panel-collapse collapse" aria-expanded="false" style="height: 0px;">
                                    <div class="panel-body">
                                        <form id="login-form" class="smart-form" action="{{route('backoffice_contrats_location')}}" method="get">
                                                ...
                                                <fieldset>
                                                        <div class="row">
                                                                ...
                                                                <div class="col col-3">
                                                                        ...
                                                                        <label class="input">
                                                                                <input type="text" class="form-control" name="vehicule" value="{{$selected_vehicule}}" >
                                                                        </label>
                                                                    </div>
                    ...
                    <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12 sortable-grid ui-sortable">
                        ...
                        <div class="jarviswidget jarviswidget-sortable" id="wid-id-0" data-widget-editbutton="false" data-widget-colorbutton="false" 
                            ...
                            <header>
                                ...
                                <p class="h6">&nbsp;Contrats de location</p>
                            </header>                            
                            <!-- widget div-->
                            <div>
                                <!-- widget content -->
                                        ...
                                        <tbody>
                                            @foreach($contrats as $contrat)
                                                <tr>
                                                    ...
                                                    <td>
                                                    @permission('Modifier') 
                                                    <button class="btn btn-secondary" onclick="window.location.href='{{route('backoffice_contrat_location_modif',$contrat->id)}}'"><i class="fa fa-edit"></i></button>
                                                    @endpermission
                                                    @permission('Supprimer') 
                                                    <button class="btn btn-red" data-toggle="modal" data-target="#Supprimer-{{$contrat->id}}"> <i class="fa fa-trash"></i></button>
                                                    @endpermission
                                                    <button class="btn btn-default" onclick="window.location.href='{{route('backoffice_contrat_location_visualiser',$contrat->id)}}'"> <i class="fa fa-eye"></i></button>
                                                    </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
    ...
    <!-- Modal: Supprimer -->
    @foreach($contrats as $contratlocation)
        <div class="modal fade" id="Supprimer-{{$contratlocation->id}}"  tabindex="-1" role="dialog">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body no-padding">
                        <form id="login-form" class="smart-form" action="{{route('backoffice_contrat_location_supprimer')}}" method="POST">
                            {{csrf_field()}}
                            {{method_field('delete')}}
                            <fieldset>                                            
                                <input type="hidden" name="id" value="{{$contratlocation->id}}">
                                <div class="">
