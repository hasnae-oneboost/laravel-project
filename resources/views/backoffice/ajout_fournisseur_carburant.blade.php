...
@section('title')
Ajouter un nouveau fournisseur de carburant
@endsection
@section('breadcrumb')
		<!-- breadcrumb -->
    ...
    <div id="content">
        ...
        <section id="widget-grid" class="">
            ...
            <div class="row">             
                    ...
                    <form class="" files="true" action="{{route('backoffice_fournisseur_carb_ajouter')}}" method="POST" enctype="multipart/form-data">
                                        {{csrf_field()}}
