...
@section('title')
Ajouter un nouveau courtier d'assurance
@endsection
@section('breadcrumb')
		<!-- breadcrumb -->
    ...
    <div id="content">
        ...
        <section id="widget-grid" class="">
            ...
            <div class="row">             
                    ...
                    <form class="" files="true" action="{{route('backoffice_courtiers_ajouter')}}" method="POST" enctype="multipart/form-data">
                                        {{csrf_field()}}
                                    ...
                                    <div>
                                        ...
                                        <fieldset>
                                            <div class="form-group">
                                                            ...
                                                            <div class="col-md-10">
                                                                <input class="form-control" type="text" id="" name="matricule" required>
                                                            </div>
                                            </div>
                                                    ...
                                                    <div class="form-group" >
                                                            ...
                                                            <div class="col-md-10" style="margin-top: 15px">
                                                                <input class="form-control" type="text" id="" name="nom" required>
                                                    ...
                                                    <div class="form-group" >
                                                        ...
                                                        <div class="col-md-10" style="margin-top: 15px">
                                                           <select class="societe_select" name="societe_assurance" id="societe_assurance" style="width:695px;" >
                                                            <option value=""></option>
