                            ...
                            <div class="pull-right">
                                    <div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
                                        <h1 class="page-title txt-color-blueDark">
                                         @permission('Créer') 
                                            <div class="">                                            
                                            <a href="{{route('backoffice_fournisseur_vehicule_ajout')}}" class="btn btn-red btn-lg">Ajouter</a>    
                                            </div>
                                        @endpermission
                                        </h1>
                                    </div>
                    ...
                    <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12 sortable-grid ui-sortable">
                        ...
                        data-widget-deletebutton="false" data-widget-togglebutton="false" role="widget">
                            <header>
                                ...
                                <p class="h6">&nbsp;Fournisseurs de véhicules</p>  
                            </header>
                                    ...
                                    <table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                @permission('Modifier') 
                                                    <button class="btn btn-secondary" onclick="window.location.href='{{route('backoffice_fournisseur_vehicule_modif',$f->id)}}'"><i class="fa fa-edit"></i></button>
                                                @endpermission
                                                @permission('Supprimer') 
                                                    <button class="btn btn-red" data-toggle="modal" data-target="#Supprimer-{{$f->id}}"> <i class="fa fa-trash"></i></button>
                                                @endpermission
                                                <button class="btn btn-default" onclick="window.location.href='{{route('backoffice_fournisseur_vehicule_visualiser',$f->id)}}'"> <i class="fa fa-eye"></i></button>
                                            </td>
