        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body no-padding">
                    ...
                    <form id="login-form" class="smart-form" action="{{route('backoffice_direction_ajouter')}}" method="POST">
                        {{csrf_field()}}
                                <fieldset>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body no-padding">
                ...
                <form id="login-form" class="smart-form" action="{{route('backoffice_direction_modifier')}}" method="POST">
                    {{csrf_field()}}
                    {{method_field('PATCH')}}                            
                        <fieldset>
                            <section>
...
<div class="modal fade" id="Visualiser-{{$dir->id}}" tabindex="-1" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col col-10">
                                            <label class="input">
                                                ...
                                                <input type="text" name="libelle" value="{{$dir->libelle}}" disabled>
                                            </label>
                                        </div>
                                    </div>
                            </section>
...
<div class="modal fade" id="Supprimer-{{$dire->id}}"  tabindex="-1" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
            ...
            <form id="login-form" class="smart-form" action="{{route('backoffice_direction_supprimer')}}" method="POST">
                    {{csrf_field()}}
                    {{method_field('delete')}}
                            <fieldset>                                            
                                    <input type="hidden" name="id" value="{{$dire->id}}">
                                    <div class="">
