                                            ...
                                            <fieldset>
                                                <div class="row">
                                                    ...
                                                    <section class="col col-6">
                                                            ...
                                                            <label class="input">                                                                    
                                                                    <input type="text"  class="form-control" name="date" id="date" value="{{$appelclient->date_appel}}" disabled>
                                                            </label>
                                                    ...
                                                    <section class="col col-6">
                                                                        ...
                                                                        <div class="input-group" id="heure" class="input-append">                                                                    
                                                                                <input type="text" data-format="hh:mm:ss"  class="form-control " name="heure" value="{{$appelclient->heure_appel}}"  disabled>
                                                                                <span class="input-group-addon add-on" >
                                                                                   <i data-time-icon="icon-time" disabled>
                                                                                    </i>
                                                                                  </span>
                                                                                </div>
                                                    </section>
                                                    <section class="col col-6">
                                                        ...
                                                        <label class="input">                                                                    
                                                                <input type="text"  class="form-control" name="resume_appel" value="{{$appelclient->resume_appel}}" disabled>
                                                ...
                                                <div class="row">
                                                    <section class="col col-6">
                                                            ...
                                                            <label class="input">                                                                    
                                                                    <input type="text"  class="form-control" name="prochain_appel" value="{{$appelclient->prochain_appel}}" disabled> 
                                                            </label>
                                                        </section>
                                                </div>     
