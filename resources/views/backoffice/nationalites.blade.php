        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body no-padding">
                    ...
                    <form id="login-form" class="smart-form" action="{{route('backoffice_nationalite_ajouter')}}" method="POST">
                        {{csrf_field()}}
                                <fieldset>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body no-padding">
                ...
                <form id="login-form" class="smart-form" action="{{route('backoffice_nationalite_modifier')}}" method="POST">
                    {{csrf_field()}}
                    {{method_field('PATCH')}}
...
<div class="modal fade" id="Visualiser-{{$natio->id}}" tabindex="-1" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                    ...
                    <fieldset>
                            <section>
                                    <div class="row">
                                        ...
                                        <div class="col col-10">
                                            <label class="input">
                                                <input type="hidden" name="id" value="{{$natio->id}}">
                                                <input type="text" name="libelle" value="{{$natio->libelle}}" disabled>
                                            </label>
                                        </div>
                                    </div>
                            </section>
                            <section>
                                    <div class="row">
                                        ...
                                        <div class="col col-10">
                                            <label class="input">
                                                <input type="text" name="description" value="{{$natio->description}}" disabled>
                                            </label>
                                        </div>
                                    </div>
                            </section>
...
<div class="modal fade" id="Supprimer-{{$nat->id}}"  tabindex="-1" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
            ...
            <form id="login-form" class="smart-form" action="{{route('backoffice_nationalite_supprimer')}}" method="POST">
                    {{csrf_field()}}
                    {{method_field('delete')}}
                            <fieldset>                                            
