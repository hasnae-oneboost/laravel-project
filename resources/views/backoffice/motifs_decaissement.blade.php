                                        ...
                                        <div class="panel panel-default">
                                          ...
                                          <div id="collapseOne" class="panel-collapse collapse" aria-expanded="false" style="height: 0px;">
                                            <div class="panel-body">
                                                <form id="login-form" class="smart-form" action="{{route('backoffice_motifs_decaissement')}}" method="get">
                                                        <fieldset>
                                                                <div class="row">
                                                                                    ...
                                                                                    <label class="select">                                                                    
                                                                                            <select name="categorie_id" class="categorie_motif_enc_select" style="width: 100%">
                                                                                                    <option value=""></option>
                                                                                                        ...
                                                                                                        <option value="{{$mf->categorie_motif_id}}" @if( $selected_categorie  == $mf->categorie_motif_id) selected="selected" @endif >{{$mf->categoriesmotifsdecaissement->libelle}}</option>
                    ...
                    <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12 sortable-grid ui-sortable">
                        ...
                        data-widget-deletebutton="false" data-widget-togglebutton="false" role="widget">
                            ...
                            <header>
                                ...
                                <p class="h6">&nbsp;Motifs du decaissement</p>  
                                    ...
                                    <table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
                                        ...
                                        <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{$m->categoriesmotifsdecaissement->libelle}}</td>                                                                                                   
                                                    <td>{{$m->description}}</td>                                                
                                                    <td>{{$m->ajoute_par}}</td>
                                                    <td>{{$m->modifie_par}}</td>
                                                    <td>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body no-padding">
                    ...
                    <form id="login-form" class="smart-form" action="{{route('backoffice_motifs_decaissement_ajouter')}}" method="POST">
                        {{csrf_field()}}
                                <fieldset>
                                        <section>
                                                <div class="row">
                                    ...
                                    <section>
                                            <div class="row">
                                                ...
                                                <div class="col col-10">
                                                    <label class="input">
                                                            <select name="categorie_motif_id" class="categorie_motif_dec_select" required >
                                                                    <option value="" ></option>
                                                                    @foreach($decaissement as $e)
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body no-padding">
                ...
                <form id="login-form" class="smart-form" action="{{route('backoffice_motifs_decaissement_modifier')}}" method="POST">
                    {{csrf_field()}}
                    {{method_field('PATCH')}}
                        ...
                        <section>
                                <div class="row">
                                    ...
                                    <div class="col col-10">
                                        <label class="input">
                                                <select name="categorie_motif_id" class="categorie_motif_dec_select" required >
                                                        <option value="{{$mo->categorie_motif_id}}" >{{$mo->categoriesmotifsdecaissement->libelle}}</option>
                                                        @foreach($decaissement as $e)
                                                        <option value="{{$e->id}}" >{{$e->libelle}}</option>
                                                        @endforeach
                                                    </select>
                        ...
                        <fieldset>
                            ...
                            <section>
                                    <div class="row">
                                        ...
                                        <div class="col col-10">
                                            <label class="input">
                                                    <select name="categorie_motif_id" class="categorie_motif_dec_select" disabled>
                                                            <option value="{{$mot->categorie_motif_id}}" >{{$mot->categoriesmotifsdecaissement->libelle}}</option>
                                                        </select>
                                            </label>
                                        </div>
                                    </div>
...
<div class="modal fade" id="Supprimer-{{$motif->id}}"  tabindex="-1" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="login-form" class="smart-form" action="{{route('backoffice_motifs_decaissement_supprimer')}}" method="POST">
                    {{csrf_field()}}
                    {{method_field('delete')}}
                            <fieldset>                                            
