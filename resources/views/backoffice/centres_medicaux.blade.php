                            ...
                            <div>
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
                                        ...
                                        <tbody>
                                                @foreach($centreMedical as $centre)
                                                <tr>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body no-padding">
                    ...
                    <form id="login-form" class="smart-form" action="{{route('backoffice_centre_medical_ajouter')}}" method="POST">
                        {{csrf_field()}}
                                <fieldset>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body no-padding">
                ...
                <form id="login-form" class="smart-form" action="{{route('backoffice_centre_medical_modifier')}}" method="POST">
                    {{csrf_field()}}
                    {{method_field('PATCH')}}
...
<div class="modal fade" id="Supprimer-{{$cen->id}}"  tabindex="-1" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="login-form" class="smart-form" action="{{route('backoffice_centre_medical_supprimer')}}" method="POST">
                    {{csrf_field()}}
                    {{method_field('delete')}}
                            <fieldset>                                            
