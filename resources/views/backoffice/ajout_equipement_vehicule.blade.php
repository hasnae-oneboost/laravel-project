...
@section('title')
Ajouter un nouveau equipement de véhicule
@endsection
@section('breadcrumb')
		<!-- breadcrumb -->
                        ...
                        <article class="col-sm-12 col-md-12 col-lg-12">
                            ...
                            <div class="jarviswidget" id="wid-id-0" data-widget-colorbutton="false" data-widget-deletebutton="false" data-widget-togglebutton="false" data-widget-editbutton="false" data-widget-custombutton="false">
                                ...
                                <header>
                                        ...
                                        <h2>Ajouter un nouveau equipement de véhicule</h2>
                                ...
                                <div class="widget-body">
                                    ...
                                    <form class="smart-form" files="true" action="{{route('backoffice_equipements_vehicules_ajouter')}}" method="POST" enctype="multipart/form-data">
                                                    {{csrf_field()}}
                                         <header></header>
                                            ...
                                            <fieldset>
                                                ...
                                                <div class="row">
                                                    <section class="col col-6">
                                                        ...
                                                        <label class="input">                                                                    
                                                                        <input type="text"  class="form-control" id="date" name="date_affectation" value="" required>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <section class="col col-6">
                                                                                ...
                                                                                <label class="input">                                                                    
                                                                                        <input type="text"  class="form-control" id="date" name="date_debut" value="" required>
                                                    ...
                                                    <section class="col col-6">
                                                                                    ...
                                                                                    <label class="input">                                                                    
                                                                                            <input type="text"  class="form-control" id="date" name="date_fin" value="" required>
