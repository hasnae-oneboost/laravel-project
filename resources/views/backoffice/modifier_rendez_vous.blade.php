                    ...
                    <div class="row">
                        ...
                        <article class="col-sm-12 col-md-12 col-lg-12">
                            ...
                            <div class="widget-body">
                                    ...
                                    <form class="smart-form" files="true" method="POST" action="{{route('backoffice_rendez_vous_modifier')}}">
                                            {{csrf_field()}}
                                            {{method_field('PATCH')}}                                           
                                            ...
                                            <fieldset>
                                                <div class="row">
                                                    ...
                                                    <section class="col col-6">
                                                            ...
                                                            <label class="input">                                                                    
                                                                    <input type="text"  class="form-control" name="date" id="date" value="{{$rdvclient->date}}" required>
                                                            </label>
                                                    ...
                                                    <section class="col col-6">
                                                                        ...
                                                                        <div class="input" id="heure" class="input-append">                                                                    
                                                                                <input type="text" data-format="hh:mm:ss"  class="form-control " name="heure" value="{{$rdvclient->heure}}"  required>
                                                                                <span class="add-on">
                                                    ...
                                                    <section class="col col-6">
                                                        ...
                                                        <label class="input">                                                                    
                                                                <input type="text"  class="form-control" name="description" value="{{$rdvclient->description}}" required>
