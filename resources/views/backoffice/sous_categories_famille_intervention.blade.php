                    ...
                    <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12 sortable-grid ui-sortable">
                        ...
                        data-widget-deletebutton="false" data-widget-togglebutton="false" role="widget">
                            <header>
                                ...
                                <p class="h6">&nbsp;Sous categories de famille d'intervention</p>
                            </header>
                                    ...
                                    <table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
                                        ...
                                        <tbody>
                                                ...
                                                <tr>
                                                    <td>{{$c->code}}</td> 
                                                    <td>{{$c->libelle}}</td> 
                                                    <td>{{$c->categoriesintervention->libelle}}</td>
                                                    <td>{{$c->commentaire}}</td>                                              
                                                    <td>{{$c->ajoute_par}}</td>
                                                    <td>{{$c->modifie_par}}</td>
                                                    <td>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body no-padding">
                    ...
                    <form id="login-form" class="smart-form" action="{{route('backoffice_sous_categories_fam_ajouter')}}" method="POST">
                        {{csrf_field()}}
                                <fieldset>
                                    <section>
                                                <div class="row">
                                                ...
                                                <div class="col col-10">
                                                    <label class="select">
                                                        <select name="categories"  required>
                                                            <option value=""></option>
                                                            @foreach($categories_famille as $f)
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body no-padding">
                ...
                <form id="login-form" class="smart-form" action="{{route('backoffice_sous_categories_fam_modifier')}}" method="POST">
                    {{csrf_field()}}
                    {{method_field('PATCH')}}                            
                        <fieldset>
                            ...
                            <section>
                                    <div class="row">
                                        ...
                                        <div class="col col-10">
                                            <label class="select">
                                                <select name="categories"  required>
                                                    <option value="{{$c->categorie_id}}">{{$c->categoriesintervention->libelle}}</option>
                                                    @foreach($categories_famille as $caa)
                                                       <option value="{{$caa->id}}">{{$caa->libelle}}</option> 
                                                    @endforeach
                                                </select>
                                            </label>
                                        </div>
                                        ...
                                        <div class="col col-10">
                                            <label class="select">
                                                <select name="categories"  disabled>
                                                    <option value="{{$cate->categorie_id}}">{{$cate->categoriesintervention->libelle}}</option>
                                                    @foreach($categories_famille as $categorie)
...
<div class="modal fade" id="Supprimer-{{$cat->id}}"  tabindex="-1" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="login-form" class="smart-form" action="{{route('backoffice_sous_categories_fam_supprimer')}}" method="POST">
                    {{csrf_field()}}
                    {{method_field('delete')}}
                            <fieldset>                                            
