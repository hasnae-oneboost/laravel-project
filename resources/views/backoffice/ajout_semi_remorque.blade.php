...
@section('title')
Ajouter un nouveau semi-remorque
@endsection
@section('breadcrumb')
		<!-- breadcrumb -->
...
<div id="main" role="main">
    ...
    <div id="content">
        ...
        <section id="widget-grid" class="">
            <!-- row -->
            <div class="row">                
                <form class="" files="true" action="{{route('backoffice_semi_remorque_ajouter')}}" method="POST" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <!-- NEW WIDGET START -->
                                            ...
                                            <div class="form-group" >
													...
													<div class="col-md-10" style="margin-top: 15px">
                                                        <select class="form-control" name="type" id="" required>
                                                                <option value=""></option>
                                                                @foreach($typessemiremorq as $typessemi)
                                                                <option value="{{$typessemi->id}}">{{$typessemi->libelle}}</option>
                                                                @endforeach
                                                        </select>
                                                    </div>
                                            </div>
