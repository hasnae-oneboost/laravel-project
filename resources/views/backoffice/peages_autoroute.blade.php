        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body no-padding">             
                    ...
                    <form id="login-form" class="smart-form" action="{{route('backoffice_peage_autoroute_ajouter')}}" method="POST">
                        {{csrf_field()}}
                                <fieldset>                                    
                                    <section>
                                            <div class="row">
                                                <label class="label col col-2">Péage</label>
                                                <div class="col col-10">
                                                    <label class="input">
                                                        <input type="text" name="peage" required>
                                                    </label>
                                                </div>
                                            </div>
                                    </section>                                                                                   
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body no-padding">
                ...
                <form id="login-form" class="smart-form" action="{{route('backoffice_peage_autoroute_modifier')}}" method="POST">
                    {{csrf_field()}}
                    {{method_field('PATCH')}}                            
                        <fieldset>
                            <section>
                                    <div class="row">
                                        ...
                                        <div class="col col-10">
                                            <label class="input">
                                                ...
                                                <input type="text" name="peage" value="{{$ca->peage}}" required>
                                            </label>
                                        </div>
                                    </div>
                            </section>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col col-10">
                                            <label class="input">
                                                ...
                                                <input type="text" name="peage" value="{{$cat->peage}}" disabled>
                                            </label>
                                        </div>
                                    </div>
                            </section>
...
<div class="modal fade" id="Supprimer-{{$cate->id}}"  tabindex="-1" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="login-form" class="smart-form" action="{{route('backoffice_peage_autoroute_supprimer')}}" method="POST">
                    {{csrf_field()}}
                    {{method_field('delete')}}
                            <fieldset>                                            
