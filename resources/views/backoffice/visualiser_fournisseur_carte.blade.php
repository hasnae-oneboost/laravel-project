...
@section('title')
Visualiser fournisseur de cartes
@endsection
@section('breadcrumb')
		<!-- breadcrumb -->
		<ol class="breadcrumb" style="background-color: #333;" >
                ...
                <li><a href="{{route('backoffice_fournisseur_cartes')}}">Fournisseur de cartes</a></li>
               <li>@yield('title')</li>	
		</ol>
		<!-- end breadcrumb -->
@endsection
    ...
    <div id="content">
        ...
        <section id="widget-grid" class="">
            ...
            <div class="row">             
                    ...
                    <form class="" files="true" action="{{route('backoffice_fournisseur_carte_modifier')}}" method="POST" enctype="multipart/form-data">
                                        {{csrf_field()}}
                                        {{method_field('PATCH')}}                
                        <!-- NEW WIDGET START -->
                                        ...
                                        <fieldset>
                                            <div class="form-group">
                                                            ...
                                                            <input type="hidden" name="id" value="{{$fournisseurs->id}}">                                                                
                                                                <input class="form-control" type="text" id="" name="code" value="{{$fournisseurs->code}}" disabled>
                                                            </div>
                                            </div>
                                                    ...
                                                    <div class="form-group" >
                                                            ...
                                                            <div class="col-md-10" style="margin-top: 15px">
                                                                <input class="form-control" type="text" id="" name="libelle" value="{{$fournisseurs->libelle}}" disabled>
                                                    ...
                                                    <div class="form-group" >
                                                            ...
                                                            <div class="col-md-10" style="margin-top: 15px">
                                                            <input class="form-control" type="text" id="" name="adresse" value="{{$fournisseurs->adresse}}" disabled>
                                        ...
                                        <div>                                    
                                            ...
                                            <fieldset>
                                                ...
                                                <div class="form-group" >
                                                        ...
                                                        <div class="col-md-10" style="margin-top: 15px">
                                                            <input class="form-control" type="text" id="" name="if" value="{{$fournisseurs->if}}" disabled>
                                                        </div>
                                                </div>
                                                <div class="form-group" >
                                                        <div class="col-md-2">
                                                        ...
                                                        <div class="col-md-10" style="margin-top: 15px">
                                                            <input class="form-control" type="text" id="" name="compte_bancaire" value="{{$fournisseurs->compte_bancaire}}" disabled>
                                                        </div>
                                                </div>                                               
                                            </fieldset>
                                            <fieldset>
                                            ...
                                            <div class="widget-body">
                                                    <fieldset>
                                                            ...
                                                            <div class="form-group" >
                                                                            ...
                                                                            <div class="col-md-10" style="margin-top: 15px">
                                                                            <input type="text" name="fixe2" class="form-control" value="{{$fournisseurs->fixe2}}" disabled>
                                                                            </div>
                                                            </div>
                                                            <div class="form-group" >
                                                                            <div class="col-md-2" style="margin-top: 15px">
                                                                            ...
                                                                            <div class="col-md-10" style="margin-top: 15px">
                                                                                <input class="form-control" name="fixe3" type="text" value="{{$fournisseurs->fixe3}}" disabled>
                                                                            </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group" >
                                                                            ...
                                                                            <div class="col-md-10" style="margin-top: 15px">
                                                                                <input class="form-control" name="fixe4" type="text" value="{{$fournisseurs->fixe4}}" disabled>        
                                                                            </div>
                                                            </div>
                                                            <div class="form-group" >
                                                                            <div class="col-md-2" style="margin-top: 15px">
                                                                            ...
                                                                            <div class="col-md-10" style="margin-top: 15px">
                                                                            <input class="form-control" name="gsm1" type="text" value="{{$fournisseurs->gsm1}}" disabled>        
                                            ...
                                            <div class="widget-body">
                                                    <fieldset>
                                                            <div class="form-group">
                                                                            ...
                                                                            <div class="col-md-10">
                                                                                <input class="form-control" name="gerant" type="text" value="{{$fournisseurs->gerant}}" disabled>        
                                                                            </div>
                                                            </div>
                                                                    ...
                                                                    <div class="form-group" >
                                                                            ...
                                                                            <div class="col-md-10" style="margin-top: 15px">
                                                                            <input type="text" name="responsable" class="form-control" value="{{$fournisseurs->responsable}}" disabled>
                                                                            </div>
                                                                    </div>
                                                    </fieldset>
                                                    <fieldset>
                                                                    <div class="form-group" >
                                                                            ...
                                                                            <div class="col-md-10" style="margin-top: 15px">
                                                                                <input class="form-control" name="site_web" type="text" value="{{$fournisseurs->site_web}}" disabled>
                                                                            </div>
                                                                    </div>
                                                                    <div class="form-group" >
                                                                            <div class="col-md-2" style="margin-top: 15px">
                                                                            ...
                                                                            <div class="col-md-10" style="margin-top: 15px">
                                                                                <input class="form-control" name="commentaire" type="text" value="{{$fournisseurs->commentaire}}" disabled>
                                                                            </div>
                                                                    </div>
