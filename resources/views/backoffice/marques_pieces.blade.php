                        ...
                        <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12 sortable-grid ui-sortable">
                            ...
                            data-widget-deletebutton="false" data-widget-togglebutton="false" role="widget">
                                <header>
                                    ...
                                    <p class="h6">&nbsp;Marques des pièces</p>
                                </header>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body no-padding">
                    <form id="login-form" class="smart-form" action="{{route('backoffice_marques_pieces_ajouter')}}" method="POST">
                        {{csrf_field()}}
                                <fieldset>                                    
                                    <section>
                                            <div class="row">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body no-padding">
                ...
                <form id="login-form" class="smart-form" action="{{route('backoffice_marques_pieces_modifier')}}" method="POST">
                    {{csrf_field()}}
                    {{method_field('PATCH')}}                            
                        <fieldset>
                            <section>
                            ...
                            <section>
                                    <div class="row">
                                        ...
                                        <div class="col col-10">
                                            <label class="input">
                                                    <input type="text" name="description" value="{{$ma->description}}" required>                                                
                                            </label>
                                        </div>
                                    </div>
                            </section>
                    ...
                    <fieldset>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col col-10">
                                            <label class="input">
                                                ...
                                                <input type="text" name="libelle" value="{{$mar->libelle}}" disabled>
                                            </label>
                                        </div>
                                    </div>
                            </section>
                            <section>
                                    <div class="row">
                                        ...
                                        <div class="col col-10">
                                            <label class="input">
                                                    <input type="text" name="description" value="{{$mar->description}}" disabled>                                                
...
<div class="modal fade" id="Supprimer-{{$marq->id}}"  tabindex="-1" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
            ...
            <form id="login-form" class="smart-form" action="{{route('backoffice_marques_pieces_supprimer')}}" method="POST">
                    {{csrf_field()}}
                    {{method_field('delete')}}
                            <fieldset>                                            
                                    <input type="hidden" name="id" value="{{$marq->id}}">
                                    <div class="">
