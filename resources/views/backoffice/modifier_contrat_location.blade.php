...
@section('breadcrumb')
		...
		<ol class="breadcrumb" style="background-color: #333;" >
            ...
            <li>Flotte</li>
            <li><a href="{{route('backoffice_contrats_location')}}">Contrats de location</a></li>
            <li>@yield('title')</li>	
		</ol>
		<!-- end breadcrumb -->
@endsection
                                    ...
                                    <article class="col-sm-12 col-md-12 col-lg-12">
                                        ...
                                        <div class="jarviswidget" id="wid-id-0" data-widget-colorbutton="false" data-widget-deletebutton="false" data-widget-togglebutton="false" data-widget-editbutton="false" data-widget-custombutton="false">
                                            ...
                                            <header>
                                                    ...
                                                    <h2>Modifier le Contrat de location </h2>
                                            ...
                                            <div class="widget-body">
                                              ...
                                              <form class="smart-form" files="true" action="{{route('backoffice_contrat_location_modifier')}}" method="POST" enctype="multipart/form-data">
                                            {{csrf_field()}}
                                            {{method_field('PATCH')}}
                                                <header></header>
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="row">
                                                <section class="col col-6">
                                                        ...
                                                        <label class="input">                                                                    
                                                                <select name="vehicule" id="" required>
                                                                    <option value="{{$contrats->vehicule}}" >{{$contrats->vehicule}}</option>
                                            ...
                                            <section class="col col-6">
                                                                ...
                                                                <label class="input">                                                                    
                                                                    <input type="text" class="form-control" name="duree" value="{{$contrats->duree}}" required>
                                                                </label>
                                            </section>   
                                        </div>
                                        <div class="row">
