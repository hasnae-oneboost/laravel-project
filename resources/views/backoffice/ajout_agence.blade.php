                        ...
                        <article class="col-sm-12 col-md-12 col-lg-12">
                            ...
                            <div class="jarviswidget" id="wid-id-0" data-widget-colorbutton="false" data-widget-deletebutton="false" data-widget-togglebutton="false" data-widget-editbutton="false" data-widget-custombutton="false">
                                ...
                                <header>
                                        ...
                                        <h2>Ajouter une nouvelle agence bancaire</h2>
                                ...
                                <div class="widget-body">
                                    ...
                                    <form class="smart-form" files="true" action="{{route('backoffice_agences_ajouter')}}" method="POST" enctype="multipart/form-data">
                                                    {{csrf_field()}}
                                         <header></header>
                                            ...
                                            <fieldset>
                                                <div class="row">
                                                    ...
                                                    <section class="col col-6">
                                                                        ...
                                                                        <label class="input">                                                                    
                                                                                <input type="text"  class="form-control" name="directeur" value="" required>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <section class="col col-6">
                                                                                    ...
                                                                                    <label class="input">                                                                    
                                                                                            <input type="text"  class="form-control" name="charg̩_de_la_client̬le" value="" required>
                                                    ...
                                                    <section class="col col-6">
                                                                ...
                                                                <label class="input">                                                                    
                                                                        <input type="text"  class="form-control" name="telephone_charg̩_de_la_client̬le" value="" required>
                                                                </label>
                                                    </section>
                                                    <section class="col col-6">
                                                                <label class="label">
                                                                ...
                                                                <label class="input">                                                                    
                                                                        <input type="text"  class="form-control" name="email_charg̩_de_la_client̬le" value="" required>
