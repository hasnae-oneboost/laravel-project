                                ...
                                <div class="widget-body">
                                        <fieldset>
                                                <div class="form-group">
                                                                ...
                                                                <div class="col-md-10">
                                                                    <input class="form-control" name="immatriculation" type="text" value="{{$voitureservice->immatriculation}}" disabled>        
                                                                </div>
                                                </div>
                                                        ...
                                                        <div class="form-group" >
                                                                ...
                                                                <div class="col-md-10" style="margin-top: 15px">
                                                                   <input type="text" name="code" class="form-control" value="{{$voitureservice->code}}" disabled>
                                                                </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group" >
                                                                ...
                                                                <div class="col-md-10" style="margin-top: 15px">
                                                                    <input class="form-control" name="numero_ordre" type="text" value="{{$voitureservice->numero_ordre}}" disabled>
                                                                </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group" >
                                                                ...
                                                                <div class="col-md-10" style="margin-top: 15px">
                                                                    <input class="form-control" name="numero_imputation" type="text" value="{{$voitureservice->numero_imputation}}" disabled>
                                        ...
                                        <fieldset>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-10" style="margin-top: 15px">
                                                                <input type="text" class="form-control" name="numero_ww" value="{{$voitureservice->numero_ww}}" disabled>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                                ...
                                                                <div class="col-md-10" style="margin-top: 15px">
                                                                    <input type="text" class="form-control" name="numero_carte_grise" value="{{$voitureservice->numero_carte_grise}}" disabled>
                                                                </div>
                                                        </div>
                                                        <div class="form-group">
                                                                <div class="col-md-2" style="margin-top: 15px">
                                                                ...
                                                                <div class="col-md-10" style="margin-top: 15px">
                                                                    <input type="text" class="form-control" name="numero_chassis" value="{{$voitureservice->numero_chassis}}" disabled>
                                                                </div>
                                                        </div>
                                                        <div class="form-group" >
                                                                <div class="col-md-2" style="margin-top: 15px">
                                ...
                                <div>
                                    ...
                                    <fieldset>
                                        <div class="form-group">
                                                        ...
                                                        <div class="col-md-10">
                                                            <input class="form-control" type="text" id="date" name="date_entree_parc" value="{{$voitureservice->date_entree_parc}}" disabled>
                                                        </div>
                                        </div>
                                    </fieldset>
                                    <fieldset>
                                        <div class="form-group" >
                                                ...
                                                <div class="col-md-10" style="margin-top: 15px">
                                                    <input class="form-control" type="text" id="date" name="date_mise_en_circulation" value="{{$voitureservice->date_mise_en_circulation}}" disabled>
                                                </div>
                                        </div>
                                    </fieldset>
                                        <fieldset>
                                        <div class="form-group" >
                                                ...
                                                <div class="col-md-10" style="margin-top: 15px">
                                                    <input class="form-control" type="text" id="date" name="date_restitution" value="{{$voitureservice->date_restitution}}" disabled>
                                                </div>
                                        </div>
                                        <div class="form-group" >
                                                <div class="col-md-2">
                                                ...
                                                <div class="col-md-10" style="margin-top: 15px">
                                                    <input class="form-control" type="text" id="date" name="date_recepisse" value="{{$voitureservice->date_recepisse}}" disabled>
                                                </div>
                                        </div>
                                    ...
                                    <div class="widget-body">
                                            <fieldset>
                                                    <div class="form-group">
                                                                    ...
                                                                    <div class="col-md-10">
                                                                        <input class="form-control" name="couleur" type="text" value="{{$voitureservice->couleur}}" disabled>        
                                                                    </div>
                                                    </div>
                                                            ...
                                                            <div class="form-group" >
                                                                    ...
                                                                    <div class="col-md-10" style="margin-top: 15px">
                                                                       <input type="text" name="code_cle" class="form-control" value="{{$voitureservice->code_cle}}" disabled>
                                                                    </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group" >
                                                                    ...
                                                                    <div class="col-md-10" style="margin-top: 15px">
                                                                        <input class="form-control" name="description" type="text" value="{{$voitureservice->description}}" disabled>
                                                                    </div>
                                                            </div>
