...
<div id="main" role="main">
    ...
    <div id="content">
        ...
        <section id="widget-grid" class="">
            <!-- row -->
            <div class="row">                
                <form class="" files="true" action="{{route('backoffice_personnels_ajouter')}}" method="POST" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <!-- NEW WIDGET START -->
                                ...
                                <fieldset>
                                    <div class="form-group">
                                            ...
                                            <div class="form-group" >
													...
													<div class="col-md-10" style="margin-top: 15px">
                                                        <input class="form-control" type="text" id="date" name="date_naissance" required>
                                        ...
                                        <fieldset>
                                            <div class="form-group" >
													...
													<div class="col-md-10" style="margin-top: 15px">
                                                        <input class="form-control" type="text" id="date" name="date_prevue_retraite" required>
                                    ...
                                    <fieldset>
                                        <div class="form-group" >
                                            ...
                                            <div class="col-md-10" style="margin-top: 15px">
                                                <input class="form-control" type="text" name="adresse_postale" required>
                                    ...
                                    <fieldset>
                                        <div class="form-group" >
                                            ...
                                            <div class="col-md-10" style="margin-top: 15px">
                                                <input class="form-control" type="text" id="date" name="date_approbation" required>
                                ...
                                <div>                                    
                                    ...
                                    <fieldset>
                                        <div class="form-group">
                                                        ...
                                                        <div class="col-md-10">
                                                            <input class="form-control" type="text" name="gsm_professionnel" required>
                                                        </div>
                                        </div>
                                    </fieldset>
                                    <fieldset>
                                            <div class="form-group">
                                                    ...
                                                    <div class="col-md-10">
                                                        <input class="form-control" type="text" name="gsm_personnel" required>
                                                    </div>
                                    </div>
                                    </fieldset>
                                        <fieldset>
                                                <div class="form-group">
                                                        ...
                                                        <div class="col-md-10">
                                                            <input class="form-control" type="text" name="gsm_etranger" required>
                                                        </div>
                                        </div>
                                    </fieldset>
                                    <fieldset>
                                        <div class="form-group" >
                                                ...
                                                <div class="col-md-10" style="margin-top: 15px">
                                                    <input class="form-control" type="email" name="email_professionnel" required>
                                                </div>
                                        </div>                                               
                                    </fieldset>
                                    <fieldset>
                                            <div class="form-group" >
                                                    ...
                                                    <div class="col-md-10" style="margin-top: 15px">
                                                        <input class="form-control" type="email" name="email_personnel" required>
                                                    </div>
                                            </div> 
                                    </fieldset>
                                    ...
                                    <div class="widget-body">
                                            <fieldset>
                                                    <div class="form-group">
                                                                    ...
                                                                    <div class="col-md-10">
                                                                        <input class="form-control" name="contact1" type="text" required>        
                                                                    </div>
                                                    </div>   
                                                </fieldset>
                                                <fieldset>                                             
                                                    <div class="form-group" >
                                                                    ...
                                                                    <div class="col-md-10" style="margin-top: 15px">
                                                                       <input type="text" name="gsm1" class="form-control" required>
                                                                    </div>
                                                    </div>
                                                </fieldset>
                                                <fieldset>
                                                    <div class="form-group" >
                                                                    ...
                                                                    <div class="col-md-10" style="margin-top: 15px">
                                                                        <input class="form-control" name="contact2" type="text" required>
                                                                    </div>
                                                    </div>
                                                </fieldset>
                                                <fieldset>
                                                    <div class="form-group" >
                                                                    ...
                                                                    <div class="col-md-10" style="margin-top: 15px">
                                                                        <input class="form-control" name="gsm2" type="text" required>        
                                                                    </div>
                                                    </div>
                                    ...
                                    <div class="widget-body">
                                            <fieldset>
                                                    <div class="form-group">
                                                                    ...
                                                                    <div class="col-md-10">
                                                                        <input class="form-control" name="cnss" type="text" required>        
                                                                    </div>
                                                    </div>
                                                </fieldset>
                                                <fieldset>
                                                        ...
                                                        <fieldset>
                                                            <div class="form-group" >
                                                                    ...
                                                                    <div class="col-md-10" style="margin-top: 15px">
                                                                        <input class="form-control" name="date_immatriculation" id="date" type="text" required>
                                                                    </div>
                                                            </div>
                                                        </fieldset>
                                                        <fieldset>
                                                            <div class="form-group" >
                                                                    ...
                                                                    <div class="col-md-10" style="margin-top: 15px">
                                                                        <input class="form-control" name="compte_bancaire" type="text" required>
                                                                    </div>
                                                            </div>
                                                        </fieldset>
                                                        <fieldset>
                                                            <div class="form-group" >
                                                                    ...
                                                                    <div class="col-md-10" style="margin-top: 15px">
                                                                        <input class="form-control" name="numero_compte_comptable" type="text" required>
                                                                    </div>
                                                            </div>
