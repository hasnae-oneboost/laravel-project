                    ...
                    <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12 sortable-grid ui-sortable">
                        ...
                        data-widget-deletebutton="false" data-widget-togglebutton="false" role="widget">
                            ...
                            <header>
                                ...
                                <p class="h6">&nbsp;Situations familiales</p>  
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body no-padding">
                    ...
                    <form id="login-form" class="smart-form" action="{{route('backoffice_situation_ajouter')}}" method="POST">
                        {{csrf_field()}}
                                <fieldset>
...
<div class="modal fade" id="Modifier-{{$si->id}}" tabindex="-1" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
            ...
            <div class="modal-body no-padding">
                ...
                <form id="login-form" class="smart-form" action="{{route('backoffice_situation_modifier')}}" method="POST">
                    {{csrf_field()}}
                    {{method_field('PATCH')}}
                    ...
                    <fieldset>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col col-10">
                                            <label class="input">
                                                ...
                                                <input type="text" name="libelle" value="{{$si->libelle}}" required>
                                            </label>
                                        </div>
                                    </div>
                            </section>
                            <section>
                                    <div class="row">
                                        ...
                                        <div class="col col-10">
                                            <label class="input">
                                                <input type="text" name="description" value="{{$si->description}}" required>
                                            </label>
                                        </div>
                                    </div>
                            </section>
...
<div class="modal fade" id="Visualiser-{{$sit->id}}" tabindex="-1" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                    ...
                    <fieldset>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col col-10">
                                            <label class="input">
                                                ...
                                                <input type="text" name="libelle" value="{{$sit->libelle}}" disabled>
                                            </label>
                                        </div>
                                    </div>
                            </section>
                            <section>
                                    <div class="row">
                                        ...
                                        <div class="col col-10">
                                            <label class="input">
                                                <input type="text" name="description" value="{{$sit->description}}" disabled>
                                            </label>
                                        </div>
                                    </div>
                            </section>
...
<div class="modal fade" id="Supprimer-{{$situation->id}}"  tabindex="-1" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
            ...
            <form id="login-form" class="smart-form" action="{{route('backoffice_situation_supprimer')}}" method="POST">
                    {{csrf_field()}}
                    {{method_field('delete')}}
                            <fieldset>                                            
