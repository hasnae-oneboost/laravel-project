...
@section('title')
Visualiser fournisseur de véhicules
@endsection
@section('breadcrumb')
		<!-- breadcrumb -->
    ...
    <div id="content">
        ...
        <section id="widget-grid" class="">
            ...
            <div class="row">             
                    ...
                    <form class="" files="true" action="{{route('backoffice_fournisseur_vehicule_modifier')}}" method="POST" enctype="multipart/form-data">
                                        {{csrf_field()}}
                                        {{method_field('PATCH')}}                
                        <!-- NEW WIDGET START -->
