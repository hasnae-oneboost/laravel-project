                            ...
                            <article class="col-sm-12 col-md-12 col-lg-12">
                                ...
                                <div class="jarviswidget" id="wid-id-0" data-widget-colorbutton="false" data-widget-deletebutton="false" data-widget-togglebutton="false" data-widget-editbutton="false" data-widget-custombutton="false">
                                    ...
                                    <div class="widget-body">
                                        ...
                                        <form class="smart-form" files="true" action="{{route('backoffice_trajet_modifier')}}" method="POST" enctype="multipart/form-data">
                                                        {{csrf_field()}}
                                                        {{method_field('PATCH')}}
                                                ...
                                                <fieldset>
                                                    <div class="row">
                                                        ...
                                                        <section class="col col-6">
                                                            ...
                                                            <label class="input">
                                                                ...
                                                                <input type="number" min="0" class="form-control" name="numero" value="{{$trajets->numero}}" required>
                                                            </label>
                                                        ...
                                                        <section class="col col-6">
                                                                ...
                                                                <label class="input">                                                                     
                                                                        <input type="text" id="libelle" class="form-control" name="libelle" value="{{$trajets->libelle}}" required>
                                                    ...
                                                    <div class="row">
                                                            ...
                                                            <section class="col col-6">
                                                                ...
                                                                <label class="input"><i class="icon-append ">Km</i>
                                                                    <input type="number" min="0" class="form-control" name="distance" value="{{$trajets->distance}}" required>
                                                                </label>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <section class="col col-6">
                                                                ...
                                                                <label class="input">  
                                                                         <input type="text" class="form-control" name="description" value="{{$trajets->description}}" required>                                                             
                                                                </label>
                                                        </section>
                                                    </div>
