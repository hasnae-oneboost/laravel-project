                            ...
                            <article class="col-sm-12 col-md-12 col-lg-12">
                                ...
                                <div class="jarviswidget" id="wid-id-0" data-widget-colorbutton="false" data-widget-deletebutton="false" data-widget-togglebutton="false" data-widget-editbutton="false" data-widget-custombutton="false">
                                    ...
                                    <header>
                                            ...
                                            <h2>Modifier tarifs de gasoil</h2>
                                    ...
                                    <div class="widget-body">
                                        ...
                                        <form class="smart-form" files="true" action="{{route('backoffice_tarifs_gasoil_modifier')}}" method="POST" enctype="multipart/form-data">
                                            {{csrf_field()}}
                                            {{method_field('PATCH')}}
                                                ...
                                                <fieldset>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <section class="col col-6">
                                                                            ...
                                                                            <label class="input">                                                                    
                                                                                    <input type="text"  class="form-control" name="station" value="{{$tarifs->station}}" required>
                                                                            </label>
                                                        </section>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <section class="col col-6">
                                                                ...
                                                                <label class="input">                               
                                                                    <input type="number" name="ht"  min="0" step="0.01" value="{{$tarifs->montan_ht}}" required>
                                                    ...
                                                    <div class="row">
                                                            <section class="col col-6">
                                                                    ...
                                                                    <label class="input">                                                                  
                                                                        <input type="number" min="0" step="0.01" id="ttc" name="ttc"  value="{{$tarifs->montan_ttc}}" required>
