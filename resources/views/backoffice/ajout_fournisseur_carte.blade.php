...
@section('title')
Ajouter un nouveau fournisseur de cartes
@endsection
@section('breadcrumb')
		<!-- breadcrumb -->
		<ol class="breadcrumb" style="background-color: #333;" >
                ...
                <li><a href="{{route('backoffice_fournisseur_cartes')}}">Fournisseurs de cartes</a></li>
                <li>@yield('title')</li>	
		</ol>
		<!-- end breadcrumb -->
@endsection
    ...
    <div id="content">
        ...
        <section id="widget-grid" class="">
            ...
            <div class="row">             
                    ...
                    <form class="" files="true" action="{{route('backoffice_fournisseur_carte_ajouter')}}" method="POST" enctype="multipart/form-data">
                                        {{csrf_field()}}
