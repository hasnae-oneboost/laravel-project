                                ...
                                <div class="widget-body">
                                        <fieldset>
                                                <div class="form-group">
                                                                ...
                                                                <div class="col-md-10">
                                                                    <input class="form-control" name="immatriculation" type="text" value="{{$tracteurs->immatriculation}}" required>        
                                                                </div>
                                                </div>
                                                        ...
                                                        <div class="form-group" >
                                                                ...
                                                                <div class="col-md-10" style="margin-top: 15px">
                                                                   <input type="text" name="code" class="form-control" value="{{$tracteurs->code}}" required>
                                                                </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group" >
                                                                ...
                                                                <div class="col-md-10" style="margin-top: 15px">
                                                                    <input class="form-control" name="numero_ordre" type="text" value="{{$tracteurs->numero_ordre}}" required>
                                                                </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group" >
                                                                ...
                                                                <div class="col-md-10" style="margin-top: 15px">
                                                                    <input class="form-control" name="numero_imputation" type="text" value="{{$tracteurs->numero_imputation}}" required>
                                        ...
                                        <fieldset>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-10" style="margin-top: 15px">
                                                                <input type="text" class="form-control" name="numero_ww" value="{{$tracteurs->numero_ww}}" required>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                                ...
                                                                <div class="col-md-10" style="margin-top: 15px">
                                                                    <input type="text" class="form-control" name="numero_carte_grise" value="{{$tracteurs->numero_carte_grise}}" required>
                                                                </div>
                                                        </div>
                                                        <div class="form-group">
                                                                <div class="col-md-2" style="margin-top: 15px">
                                                                ...
                                                                <div class="col-md-10" style="margin-top: 15px">
                                                                    <input type="text" class="form-control" name="numero_chassis" value="{{$tracteurs->numero_chassis}}" required>
                                                                </div>
                                                        </div>
                                                        <div class="form-group" >
                                                                <div class="col-md-2" style="margin-top: 15px">
                                ...
                                <div>
                                    ...
                                    <fieldset>
                                        <div class="form-group">
                                                        ...
                                                        <div class="col-md-10">
                                                            <input class="form-control" type="text" id="date" name="date_entree_parc" value="{{$tracteurs->date_entree_parc}}" required>
                                                        </div>
                                        </div>
                                    </fieldset>
                                    <fieldset>
                                        <div class="form-group" >
                                                ...
                                                <div class="col-md-10" style="margin-top: 15px">
                                                    <input class="form-control" type="text" id="date" name="date_mise_en_circulation" value="{{$tracteurs->date_mise_en_circulation}}" required>
                                                </div>
                                        </div>
                                    </fieldset>
                                        <fieldset>
                                        <div class="form-group" >
                                                ...
                                                <div class="col-md-10" style="margin-top: 15px">
                                                    <input class="form-control" type="text" id="date" name="date_restitution" value="{{$tracteurs->date_restitution}}" required>
                                                </div>
                                        </div>
                                        <div class="form-group" >
                                                <div class="col-md-2">
                                                ...
                                                <div class="col-md-10" style="margin-top: 15px">
                                                    <input class="form-control" type="text" id="date" name="date_recepisse" value="{{$tracteurs->date_recepisse}}" required>
                                                </div>
                                        </div>
                                    ...
                                    <div class="widget-body">
                                            <fieldset>
                                                    <div class="form-group">
                                                                    ...
                                                                    <div class="col-md-10">
                                                                        <input class="form-control" name="couleur" type="text" value="{{$tracteurs->couleur}}" required>        
                                                                    </div>
                                                    </div>
                                                            ...
                                                            <div class="form-group" >
                                                                    ...
                                                                    <div class="col-md-10" style="margin-top: 15px">
                                                                       <input type="text" name="code_cle" class="form-control" value="{{$tracteurs->code_cle}}" required>
                                                                    </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group" >
                                                                    ...
                                                                    <div class="col-md-10" style="margin-top: 15px">
                                                                        <input class="form-control" name="description" type="text" value="{{$tracteurs->description}}" required>
                                                                    </div>
                                                            </div>
