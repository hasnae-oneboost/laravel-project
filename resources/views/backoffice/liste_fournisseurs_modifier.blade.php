			...
			<section id="widget-grid" class="">
                    ...
                    <div class="row">
                        ...
                        <article class="col-sm-12 col-md-12 col-lg-12">
                            ...
                            <form class="smart-form" files="true" action="{{route('backoffice_liste_fournisseurs_modifier')}}" method="POST" enctype="multipart/form-data">
                                            {{csrf_field()}}
                                            {{method_field('PATCH')}}
                                            ...
                                            <fieldset>
                                                ...
                                                <div class="row">                                                 
                                                    ...
                                                    <section class="col col-6">
                                                        ...
                                                        <label class="select">
                                                                <select name="echeance"  class="" required>
                                                            ...
                                                            <div class="inline-group">
                                                                ...
                                                                <div class="" style="margin-left: 25px">
                                                                    ...
                                                                    <div class="checkbox">
                                                                        <label>
                                                                          <input type="checkbox" class="checkbox style-0" value="Location" name="activite[]" {{ in_array('Location', $values) ? 'checked' : '' }}>
                                                                          <span>Location</span>
                                                                        </label>
                                                                    </div>
                                                                    ...
                                                                    <div class="checkbox">
                                                                        <label>
                                                                          <input type="checkbox" class="checkbox style-0" value="Société de leasing" name="activite[]" {{ in_array('Société de leasing', $values) ? 'checked' : '' }}>
                                                                    ...
                                                                    <div class="checkbox">
                                                                        <label>
                                                                          <input type="checkbox" class="checkbox style-0" value="Concessionnaire" name="activite[]" {{ in_array('Concessionnaire', $values) ? 'checked' : '' }}>
