...
@section('title')
Modifier la demande d'intervention
@endsection
@section('breadcrumb')
		<!-- breadcrumb -->
...
<div id="main" role="main">
    ...
    <div id="content">
        ...
        <section id="widget-grid" class="">
            <!-- row -->
            <div class="row">                
                <form class="" files="true" action="{{route('backoffice_demandes_interventions_modifier')}}" method="POST" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    {{method_field('PATCH')}}
                                    ...
                                    <div class="widget-body">
                                                <fieldset>
                                                        <div class="form-group">
                                                                        ...
                                                                        <div class="col-md-10">
                                                                            <input class="form-control" name="description" value="{{$demandes->description}}" type="text">        
                                                                        </div>
                                                        </div>
                                                </fieldset>
                                                <fieldset>
                                                            <div class="form-group" >
                                                                    ...
                                                                    <div class="col-md-10" style="margin-top: 15px">
                                                                       <input type="text" name="numero_systeme" value="{{$demandes->numero_systeme}}" class="form-control" readonly>
                                                                    </div>
                                                            </div>
                                                </fieldset>	
                                                <fieldset>
                                                        <div class="form-group" >
                                                                ...
                                                                <div class="col-md-10" style="margin-top: 15px">
                                                                <input type="text" name="date_demande" id="date" value="{{$demandes->date_demande}}" class="form-control">
                                                                </div>
                                                        </div>
                                                </fieldset>	
                                                <fieldset>
                                                        <div class="form-group" >
                                                                ...
                                                                <div class="col-md-10" style="margin-top: 15px">
                                                                <input type="text" name="kilometrage" value="{{$demandes->kilometrage}}" class="form-control">
                                                                </div>
                                                        </div>
                                                </fieldset>		
                                                <fieldset>
                                                        <div class="form-group" >
                                                                ...
                                                                <div class="col-md-10" style="margin-top: 15px">
                                                                <input type="text" name="index_horaire" value="{{$demandes->index_horaire}}"  class="form-control">
                                                                </div>
                                                        </div>
                                                </fieldset>		
