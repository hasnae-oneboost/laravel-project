                    ...
                    <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12 sortable-grid ui-sortable">
                        ...
                        data-widget-deletebutton="false" data-widget-togglebutton="false" role="widget">
                            <header>
                                ...
                                <p class="h6">&nbsp;Catégories des véhicules</p>
                            </header>
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
                                        ...
                                        <tbody>
                                                ...
                                                <tr>
                                                    <td>{{$c->libelle}}</td> 
                                                    <td><img src="/icone_vehicule/{{$c->icone}}" alt="icone" width="50px" height="50px" ></td>                                               
                                                    <td>{{$c->ajoute_par}}</td>
                                                    <td>{{$c->modifie_par}}</td>
                                                    <td>
                                                    @permission('Modifier') 
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body no-padding">
                    ...
                    <form id="login-form" class="smart-form" action="{{route('backoffice_categorie_vehicule_ajouter')}}" method="POST" enctype="multipart/form-data">
                        {{csrf_field()}}
                                <fieldset>                                    
                                    <section>
                                            <div class="row">
                                    ...
                                    <section>
                                        <div class="row">
                                            <label class="label col col-2">Icone</label>
                                            <div class="col col-10">
                                                <label class="input">
                                                        <input type="file" name="iconeInput">
                                                </label>
                                            </div>
                                        </div>
                                    </section>                                                                                     
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body no-padding">
                ...
                <form id="login-form" class="smart-form" action="{{route('backoffice_categorie_vehicule_modifier')}}" method="POST" enctype="multipart/form-data">
                    {{csrf_field()}}
                    {{method_field('PATCH')}}                            
                        <fieldset>
                            <section>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col col-2">
                                        <label class="input" style="margin-top: 5px">
                                                <img src="/icone_vehicule/{{$ca->icone}}" alt="icone" width="50px" height="50px" >       
                                        </label>
                                    </div>
                                </div>
                            </section>
...
<div class="modal fade" id="Supprimer-{{$cate->id}}"  tabindex="-1" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="login-form" class="smart-form" action="{{route('backoffice_categorie_vehicule_supprimer')}}" method="POST">
                    {{csrf_field()}}
                    {{method_field('delete')}}
                            <fieldset>                                            
