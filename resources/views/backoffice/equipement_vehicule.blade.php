        ...
        <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12 sortable-grid ui-sortable">
            ...
            data-widget-deletebutton="false" data-widget-togglebutton="false" role="widget">
                ...
                <header>
                    ...
                    <p class="h6">&nbsp;Equipement de véhicule</p>  
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body no-padding">                
                    ...
                    <form id="login-form" class="smart-form" action="{{route('backoffice_equipement_ajouter')}}" method="POST">
                        {{csrf_field()}}
                                <fieldset>
                                    <section>
                                        <div class="row">
                                    ...
                                    <section>
                                            <div class="row">
                                                ...
                                                <div class="col col-10">
                                                    <label class="input">
                                                        <select name="type_equipement" id="" required>
                                                            <option value=""></option>
                                                            @foreach($types as $t)
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body no-padding">
                ...
                <form id="login-form" class="smart-form" action="{{route('backoffice_equipement_modifier')}}" method="POST">
                    {{csrf_field()}}
                    {{method_field('PATCH')}}
                                ...
                                <div class="row">
                                    ...
                                    <div class="col col-10">
                                        <label class="input">
                                            ...
                                            <input type="text" name="code" value="{{$eq->code}}" required>
                                        </label>
                                    </div>
                                </div>
                            </section>
                            ...
                            <section>
                                    <div class="row">
                                        ...
                                        <div class="col col-10">
                                            <label class="input">
                                                <select name="type_equipement" id="" required>
                                                    <option value="{{$eq->typeequipementvehicule->id}}">{{$eq->typeequipementvehicule->libelle}}</option>
                                                    @foreach($types as $t)
                                                    <option value="{{$t->id}}">{{$t->libelle}}</option>
                                                    @endforeach
                                                </select>
                    ...
                    <fieldset>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col col-10">
                                        <label class="input">
                                            ...
                                            <input type="text" name="code" value="{{$equi->code}}" disabled>
                                        </label>
                                    </div>
                                </div>
                            </section>
                            ...
                            <section>
                                    <div class="row">
                                        ...
                                        <div class="col col-10">
                                            <label class="input">
                                                <select name="type_equipement" id="" disabled>
                                                    <option value="{{$equi->typeequipementvehicule->id}}">{{$equi->typeequipementvehicule->libelle}}</option>
                                                    @foreach($types as $t)
                                                    <option value="{{$t->id}}">{{$t->libelle}}</option>
                                                    @endforeach
                                                </select>
...
<div class="modal fade" id="Supprimer-{{$eqp->id}}"  tabindex="-1" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
            ...
            <form id="login-form" class="smart-form" action="{{route('backoffice_equipement_supprimer')}}" method="POST">
                    {{csrf_field()}}
                    {{method_field('delete')}}
                            <fieldset>
