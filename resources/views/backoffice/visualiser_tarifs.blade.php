                                                ...
                                                <fieldset>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <section class="col col-6">
                                                                            ...
                                                                            <label class="input">                                                                    
                                                                                    <select name="peage_depart" disabled>
                                                    ...
                                                    <div class="row">
                                                            <section class="col col-6">
                                                                    ...
                                                                    <label class="input">                                                                    
                                                                            <select name="peage_arrivee" disabled>
                                                            ...
                                                            <section class="col col-6">
                                                                    ...
                                                                    <label class="input">                                                                    
                                                                            <input type="text" name="description" value="{{$tarifs->description}}" disabled>
                                                    ...
                                                    <div class="row">
                                                        <section class="col col-6">
                                                                ...
                                                                <label class="input">                               
                                                                    <input type="number" name="ht"  min="0" step="0.01" value="{{$tarifs->montant_ht}}" disabled>
                                                    ...
                                                    <div class="row">
                                                            <section class="col col-6">
                                                                    ...
                                                                    <label class="input">                                                                  
                                                                        <input type="number" min="0" step="0.01" id="ttc" name="ttc" value="{{$tarifs->montant_ttc}}" disabled>
