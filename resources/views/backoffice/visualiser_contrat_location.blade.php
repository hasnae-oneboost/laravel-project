...
@section('title')
Visualiser le Contrat de location
@endsection
@section('breadcrumb')
		<!-- breadcrumb -->
                                    ...
                                    <article class="col-sm-12 col-md-12 col-lg-12">
                                        ...
                                        <div class="jarviswidget" id="wid-id-0" data-widget-colorbutton="false" data-widget-deletebutton="false" data-widget-togglebutton="false" data-widget-editbutton="false" data-widget-custombutton="false">
                                            ...
                                            <header>
                                                    ...
                                                    <h2>Visualiser le Contrat de location </h2>
                                    ...
                                    <fieldset>
                                        <div class="row">
                                            ...
                                            <section class="col col-6">
                                                    ...
                                                    <label class="input"> 
                                                        <select name="fournisseur" id="" disabled>
                                        ...
                                        <div class="row">
                                            ...
                                            <section class="col col-6">
                                                                ...
                                                                <label class="input">                                                                    
                                                                 <input type="text" class="form-control" name="duree" value="{{$contrats->duree}}" disabled>
