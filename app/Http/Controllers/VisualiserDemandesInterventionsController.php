...
class VisualiserDemandesInterventionsController extends Controller
{
    public function index($id)
    {
        ...
        $demandes = Demandesintervention::where('id',$id)->firstOrFail();
            ...
            $acces->page= 'Visualiser l intervention ID N°'.$id;
            $acces->date=date("Y-m-d h:i:s");
            $acces->save();

        return view('backoffice.visualiser_demande_intervention',compact('demandes','conducteurs','vehicules','categories','gravites','urgences','classe_accueil','classe_maintenance','classe_demandeintervention'));
