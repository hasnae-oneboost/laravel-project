...
class VisualiserSinistresController extends Controller
{
    public function index($id)
    {
        ...
        $acces->page= 'Visualiser sinistre ID N°: '.$id;
        $acces->date=date("Y-m-d h:i:s");
        $acces->save();

        
        return view('backoffice.visualiser_sinistre',compact('conducteurs','sinistres','pays','tracteurs','voitures','semiremorques','classe_sinistr','classe_accueil','classe_juridik'));
    }
}
