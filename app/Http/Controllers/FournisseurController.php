...
class FournisseurController extends Controller
{
    ...
    public function index()
    {
        ...
        $fournisseurs= Fournisseur::where('type','Centre de visite technique')->get();
       
        $acces= new Acce;
        $acces->utilisateur= Auth::user()->name;
        $acces->page= 'Centres de visite technique';
        $acces->date=date("Y-m-d h:i:s");
        $acces->save();
        return view('backoffice.centres_visite_technique',compact('fournisseurs','classe_referentiel','classe_intervention','classe_inter','classe_fournisseur'));
     }
    ...
    public function store(Request $request)
    {
        ...
        $fournisseurs->type = 'Centre de visite technique';
