...
class StationController extends Controller
{
    ...
    public function index()
    {
        ...
        $fournisseurs= Fournisseur::where('type','Station')->get();
        ...
        $acces->save();
        return view('backoffice.stations',compact('fournisseurs','classe_referentiel','classe_con_carburant','classe_consommation','classe_station'));
     }
    ...
    public function store(Request $request)
    {
        ...
        $fournisseurs->type = 'Station';
        $fournisseurs->ajoute_par = Auth::user()->name;
        $fournisseurs->modifie_par = ' ';
        $fournisseurs->activite = ' ';

        //Session::put('values', $fournisseurs);     
        //Redirect::to('backoffice.ajout_contact_fournisseur');
