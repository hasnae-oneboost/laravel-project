...
class ModifierContratAchatController extends Controller
{
    public function index($id)
    {
        ...
        $acces->page= 'Modifier contrat d achat N°: '.$contrats->code;
        $acces->date=date("Y-m-d h:i:s");
        $acces->save();
        
        return view('backoffice.modifier_contrat_achat',compact('contrats','tva','fournisseurs','vehicules','classe_accueil','classe_flotte','classe_contrat_achat'));
