...
class FournisseurVehiculeController extends Controller
{
    ...
    public function index()
    {
        ...
        $acces->page= 'Fournisseurs des véhicules';
        $acces->date=date("Y-m-d h:i:s");
        $acces->save();
       
        return view('backoffice.fournisseurs_vehicules',compact('fournisseurs','classe_contrat','classe_referentiel','classe_classement','classe_four_vehicule'));
    ...
    public function store(Request $request)
    {
        ...
        $fournisseurs->type = 'Fournisseur de vehicules';
