...
class FournisseurCartesController extends Controller
{
    ...
    public function index()
    {
        ...
        $classe_carte_cons=1;
        $fournisseurs= Fournisseur::where('type','Fournisseur de cartes')->get();      
        
        $acces= new Acce;
        $acces->utilisateur= Auth::user()->name;
        $acces->page= 'Fournisseurs des cartes';
        $acces->date=date("Y-m-d h:i:s");
        $acces->save();
        return view('backoffice.fournisseur_cartes',compact('fournisseurs','classe_referentiel','classe_carte_cons','classe_consommation','classe_fourn_carte'));
     }
    ...
    public function store(Request $request)
    {
        ...
        $fournisseurs->type = 'Fournisseur de cartes';
