...
class ModifierEquipementsDesVehiculesController extends Controller
{
    public function index($id)
    {
        ...
        $acces->page= 'Modifier lequipement de véhicule N°'.$id;
        $acces->date=date("Y-m-d h:i:s");
        $acces->save();

        return view('backoffice.modifier_equipement_vehicule',compact('tva','equipementsvehicules','fournisseurs','typesequipement','equipements','vehicules','classe_accueil','classe_flotte','classe_equipement_vehicule'));
